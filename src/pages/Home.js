		...
		<>
			...
			<motion.div className="main-container"
				...
				<motion.div initial={{ opacity: 1 }} exit={{ opacity: 0, transition: { type: "tween", duration: 0.15 } }} style={{ padding: "4rem", display: "flex", flexDirection: "column", alignItems: "center" }}>
					...
					<p style={{ fontSize: "1.25rem" }}>Rivers collects the world's stories so anyone experiencing challenging times can know they aren't alone. <b>100% free and anonymous.</b></p>
